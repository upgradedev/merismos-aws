...
export function DispatchJourney({row, data}: {row: OfferRow; data: Workspace}) {
  ...
  return <section className="panel padded journey" aria-label="Offer to pickup journey"><h2>From offer to pickup</h2>

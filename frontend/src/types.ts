...
export interface Pickup { offer_id: string; title: string; org: string; quantity: number; unit: string; role: string; state: string; agreed_at: string; plan_digest: string; commitment_digest?: string; run_id: string; claimed_at?: number; confirmed_at?: number | null }
